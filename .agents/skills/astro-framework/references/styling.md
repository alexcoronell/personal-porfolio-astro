...
```html
<!-- Output -->
<div class="astro-J7PV25F6 container">
...
<div class="mx-auto max-w-4xl p-4">
  <h1 class="text-blue-600 text-3xl font-bold">Hello World</h1>
  <p class="text-gray-700 mt-4 leading-relaxed">Welcome to my site.</p>
</div>
```
...
```astro
<!-- Usage -->
<Button class="custom-class mt-4">Click Me</Button>
```
